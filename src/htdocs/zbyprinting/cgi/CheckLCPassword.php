...
{
	$post = "ImgbtnLogin.x=62&ImgbtnLogin.y=15&TxtPassword=" . urlencode($password) . "&TxtUserName=" . $username . "&__EVENTARGUMENT=&__EVENTTARGET=&__VIEWSTATE=/wEPDwUJLTkwODk2MDQ5ZBgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAQULSW1nYnRuTG9naW4=";
